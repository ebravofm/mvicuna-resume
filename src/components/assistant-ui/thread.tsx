...
const UserMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="grid w-full max-w-[var(--thread-max-width)] auto-rows-auto grid-cols-[minmax(72px,1fr)_auto] gap-y-2 py-4 [&:where(>*)]:col-start-2">
      ...
      <div className="bg-neutral-200 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-100 col-start-2 row-start-2 max-w-[calc(var(--thread-max-width)*0.8)] break-words rounded-3xl px-5 py-2.5">
...
const EditComposer: FC = () => {
  return (
    <ComposerPrimitive.Root className="bg-neutral-100 dark:bg-neutral-800 my-4 flex w-full max-w-[var(--thread-max-width)] flex-col gap-2 rounded-xl">
      <ComposerPrimitive.Input className="text-neutral-900 dark:text-neutral-100 flex h-8 w-full resize-none bg-transparent p-4 pb-0 outline-none" />
...
const AssistantMessage: FC = () => {
  return (
    <MessagePrimitive.Root className="relative grid w-full max-w-[var(--thread-max-width)] grid-cols-[auto_auto_1fr] grid-rows-[auto_1fr] py-4">
      <div className="text-neutral-900 dark:text-neutral-100 col-span-2 col-start-2 row-start-1 my-1.5 max-w-[calc(var(--thread-max-width)*0.8)] break-words leading-7">
...
const AssistantActionBar: FC = () => {
  return (
    <ActionBarPrimitive.Root
      ...
      className="text-neutral-500 dark:text-neutral-400 data-[floating]:bg-white dark:data-[floating]:bg-neutral-900 col-start-3 row-start-2 -ml-1 flex gap-1 data-[floating]:absolute data-[floating]:rounded-md data-[floating]:border data-[floating]:p-1 data-[floating]:shadow-sm"
    >
...
const BranchPicker: FC<BranchPickerPrimitive.Root.Props> = ({
  ...
  return (
    <BranchPickerPrimitive.Root
      ...
      className={cn(
        "text-neutral-500 dark:text-neutral-400 inline-flex items-center text-xs",
        className,
      )}
      {...rest}
    >
